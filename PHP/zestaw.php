...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_order'])) {
    ...
    $product = "PŁYTA EX UMBRA AD LIBERTATEM + ZESTAW LOCKPICKING P8M x MOK WORKSHOP PREORDER"; // Stały produkt
    $price_per_unit = 500; // Cena za sztukę w zł
